...
"""# Dataset Preperation"""
class QNRF(Dataset):
    def __init__(self, dataset_path, target_size=(224, 224), sigma=4, transform=None):
...
def prepare_dataloaders(train_dir, test_dir, val_split=0.2):
    transform = RandomHorizontalFlip(p=0.5)
    full_train_dataset = QNRF(dataset_path=train_dir, transform=transform)
    ...
    test_dataset = QNRF(dataset_path=test_dir)
